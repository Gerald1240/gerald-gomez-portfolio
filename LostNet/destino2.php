    ...
    <div class="content">
        <div class="left-content">
            <div class="image-container">
                <img src="img/image2.jpg" alt="Producto">
            </div>
        </div>
        <div class="right-content">
            ...
            <div class="form-group">
                ...
                <div id="categoria-producto">Cargador</div>
            </div>
            <div class="form-group">
                <label for="caracteristicas">Características:</label>
                <div id="caracteristicas">iPhone, blanco</div>
            </div>
            <div class="form-group">
                <label for="fecha-encontrado">Encontrado el:</label>
                <div id="fecha-encontrado">24/10/2023</div>
            </div>
        </div>
</div>
</body>
