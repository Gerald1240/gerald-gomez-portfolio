    ...
    <div class="content">
        <div class="left-content">
            <div class="image-container">
                <img src="img/image3.jpg" alt="Producto">
            </div>
        </div>
        <div class="right-content">
            <div class="form-group">
                <label for="encontrado-en">Encontrado en:</label>
                <div id="encontrado-en">Clase A-302</div>
            </div>
            <div class="form-group">
                <label for="categoria-producto">Categoría del producto:</label>
                <div id="categoria-producto">Billetera</div>
            </div>
            <div class="form-group">
                <label for="caracteristicas">Características:</label>
                <div id="caracteristicas">hombre, negro</div>
            </div>
            <div class="form-group">
                <label for="fecha-encontrado">Encontrado el:</label>
                <div id="fecha-encontrado">25/09/2023</div>
            </div>
        </div>
</div>
</div>
