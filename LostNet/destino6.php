    ...
    <div class="content">
        <div class="left-content">
            <div class="image-container">
                <img src="imagenes/airpods.jpg" alt="Producto">
            </div>
        </div>
        <div class="right-content">
            <div class="form-group">
                <label for="encontrado-en">Encontrado en:</label>
                <div id="encontrado-en">Pabellon cH</div>
            </div>
            <div class="form-group">
                <label for="categoria-producto">Categoría del producto:</label>
                <div id="categoria-producto">Audifonos Wireless</div>
            </div>
            <div class="form-group">
                <label for="caracteristicas">Características:</label>
                <div id="caracteristicas">Audifonos blancos casi nuevos</div>
            </div>
            <div class="form-group">
                <label for="fecha-encontrado">Encontrado el:</label>
                <div id="fecha-encontrado">26/10/2023</div>
            </div>
        </div>
</div>
</div>
