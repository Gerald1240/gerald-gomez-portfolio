    ...
    <div class="content">
        <div class="left-content">
            <div class="image-container">
                <img src="img/image5.jpg" alt="Producto">
            </div>
        </div>
        <div class="right-content">
            <div class="form-group">
                <label for="encontrado-en">Encontrado en:</label>
                <div id="encontrado-en">Clase C-204</div>
            </div>
            <div class="form-group">
                <label for="categoria-producto">Categoría del producto:</label>
                <div id="categoria-producto">Guitarra</div>
            </div>
            <div class="form-group">
                <label for="caracteristicas">Características:</label>
                <div id="caracteristicas">negro, 6 cuerdas</div>
            </div>
            <div class="form-group">
                <label for="fecha-encontrado">Encontrado el:</label>
                <div id="fecha-encontrado">05/10/2023</div>
            </div>
</div>
